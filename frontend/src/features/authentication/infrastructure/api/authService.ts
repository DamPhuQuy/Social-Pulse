import type { ForgotPasswordRequest } from "@/core/types/request/ForgotPasswordRequest";
import type { LoginRequest } from "@/core/types/request/LoginRequest";
import type { RegisterApiRequest } from "@/core/types/request/RegisterApiRequest";
import type { RegisterRequest } from "@/core/types/request/RegisterRequest";
import type { ResendOtpRequest } from "@/core/types/request/ResendOtpRequest";
import type { ResetPasswordRequest } from "@/core/types/request/ResetPasswordRequest";
import type { VerifyEmailOtpRequest } from "@/core/types/request/VerifyEmailOtpRequest";

import type { LoginResponse } from "@/core/types/response/LoginResponse";
import type { LogoutResponse } from "@/core/types/response/LogoutResponse";
import type { MeResponse } from "@/core/types/response/MeResponse";
import type { PasswordResponse } from "@/core/types/response/PasswordResponse";
import type { RefreshResponse } from "@/core/types/response/RefreshResponse";
import type { RegisterResponse } from "@/core/types/response/RegisterReponse";
import type { VerifyEmailOtpResponse } from "@/core/types/response/VerifyEmailOtpResponse";
