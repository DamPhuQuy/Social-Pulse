...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center font-['Outfit'] bg-white overflow-hidden py-20">
      ...
      <nav className="absolute top-0 left-0 w-full p-8 flex items-center justify-between z-50">
        ...
        <Link to={PATHS.LOGIN} className="text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors">
          Sign In Instead
        </Link>
      </nav>
      ...
      >
        <div className="bg-white/70 backdrop-blur-2xl border border-white/50 rounded-[3rem] p-12 shadow-2xl shadow-blue-500/5">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 font-medium">Join the next generation of social networking</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center gap-3 py-2">
              <Checkbox
                ...
                className="w-6 h-6 border-2 border-gray-200 rounded-[4px] data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 transition-all cursor-pointer"
              />
              <Label htmlFor="terms" className="text-base text-gray-500 font-medium cursor-pointer select-none">
                I agree to the{" "}
                <Link to={PATHS.TERMS} className="text-blue-600 font-bold hover:underline">Terms of Service</Link>{" "}
                and{" "}
                <Link to={PATHS.PRIVACY} className="text-blue-600 font-bold hover:underline">Privacy Policy</Link>.
              </Label>
            </div>
